...
Returns the \hyperlink{namespaceprism_1_1aux_a7311aa21cf3af7c4639ea15e4716de1b}{size()} of the largest possible deque.
...
Returns true if the deque is empty. (Thus \hyperlink{namespaceprism_1_1aux_aae231a907fc705af50c90313e7f16ad0}{begin()} would equal \hyperlink{namespaceprism_1_1aux_a335f8dc9d05813c1eb69233ed66eea3d}{end()}.)
...
\end{DoxyReturn}
This operator allows for easy, array-\/style, data access. Note that data access with this operator is unchecked and out\+\_\+of\+\_\+range lookups are not defined. (For checked lookups see \hyperlink{namespaceprism_1_1aux_ad5eb3c4af48fe544355159d8e9605c89}{at()}.)
...
Safety check used only from \hyperlink{namespaceprism_1_1aux_ad5eb3c4af48fe544355159d8e9605c89}{at()}.
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
An iterator pointing to the next element (or \hyperlink{namespaceprism_1_1aux_a335f8dc9d05813c1eb69233ed66eea3d}{end()}).
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
An iterator pointing to the element pointed to by {\itshape last} prior to erasing (or \hyperlink{namespaceprism_1_1aux_a335f8dc9d05813c1eb69233ed66eea3d}{end()}).
\end{DoxyReturn}
