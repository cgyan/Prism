...
\index{Vector@{Vector}!prism\+::\+Vector@{prism\+::\+Vector}}
\subsubsection[{\texorpdfstring{Vector(std\+::initializer\+\_\+list$<$ T $>$ il)}{Vector(std::initializer_list< T > il)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ {\bf prism\+::\+Vector}$<$ T $>$\+::{\bf Vector} (
\begin{DoxyParamCaption}
\item[{std\+::initializer\+\_\+list$<$ T $>$}]{il}
\end{DoxyParamCaption}
)}\hypertarget{classprism_1_1_vector_af40c40b61dbfabdb69251abd1518773c}{}\label{classprism_1_1_vector_af40c40b61dbfabdb69251abd1518773c}
