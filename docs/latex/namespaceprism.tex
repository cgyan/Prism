...
\item 
struct \hyperlink{structprism_1_1negative}{negative}
\item 
...
\item 
struct \hyperlink{structprism_1_1positive}{positive}
\item 
...
{\footnotesize template$<$class Input\+Iterator , class Output\+Iterator , class Predicate $>$ }\\Output\+Iterator \hyperlink{namespaceprism_a1d5e88689f200fe9a6ea33642321f1fa}{remove\+\_\+copy\+\_\+if} (Input\+Iterator first, Input\+Iterator last, Output\+Iterator other\+First, Predicate pred)
...
\item 
{\footnotesize template$<$class Forward\+Iterator $>$ }\\\hyperlink{structprism_1_1iterator__traits}{prism\+::iterator\+\_\+traits}$<$ Forward\+Iterator $>$\+::difference\+\_\+type \hyperlink{namespaceprism_a533a2713a3809d8448bbfc2ebbddaa74}{distance\+\_\+aux} (Forward\+Iterator first, Forward\+Iterator last, \hyperlink{structprism_1_1forward__iterator__tag}{forward\+\_\+iterator\+\_\+tag})
\item 
{\footnotesize template$<$class Random\+Access\+Iterator $>$ }\\\hyperlink{structprism_1_1iterator__traits}{prism\+::iterator\+\_\+traits}$<$ Random\+Access\+Iterator $>$\+::difference\+\_\+type \hyperlink{namespaceprism_a3b40eca07d5c5dca59a232562628a001}{distance\+\_\+aux} (Random\+Access\+Iterator first, Random\+Access\+Iterator last, \hyperlink{structprism_1_1random__access__iterator__tag}{random\+\_\+access\+\_\+iterator\+\_\+tag})
\item 
...
\textcolor{keywordtype}{bool} allEven = \hyperlink{namespaceprism_aba366b328f3b6161e6115c16b7153c6d}{prism::all\_of}(a, a+5, isEven);
cout << allEven;
...
\hyperlink{namespaceprism_a5d0e3ddb9f698759635572f1220ec0ca}{any\+\_\+of()}
\end{DoxySeeAlso}
\begin{DoxySince}{Since}
1.\+0.\+0 
\end{DoxySince}
...
\textcolor{keywordtype}{bool} anyEven = \hyperlink{namespaceprism_a5d0e3ddb9f698759635572f1220ec0ca}{prism::any\_of}(a, a+5, isEven);
cout << anyEven;
...
\begin{DoxySeeAlso}{See also}
\hyperlink{namespaceprism_aba366b328f3b6161e6115c16b7153c6d}{all\+\_\+of()}
\end{DoxySeeAlso}
\begin{DoxySince}{Since}
1.\+0.\+0 
\end{DoxySince}
...
\hyperlink{classprism_1_1_array}{Array} specialization. \index{prism@{prism}!construct@{construct}}
...
\begin{DoxySeeAlso}{See also}
\hyperlink{namespaceprism_a2564c63b76369cc81ff725a56e818046}{copy\+\_\+backward()}, \hyperlink{namespaceprism_afbed55ae6769c2d88c125aedc2f3846e}{copy\+\_\+if()}, \hyperlink{namespaceprism_af907f3f5637d4ec056e9b833b6272953}{copy\+\_\+n()}
\end{DoxySeeAlso}
\begin{DoxySince}{Since}
1.\+0.\+0 
\end{DoxySince}
...
Returns the number of elements in the range {\itshape }\mbox{[}first,last\mbox{]} for which {\itshape pred} is true. Iterates through the range {\itshape }\mbox{[}first,last\mbox{]} and compares each element to the predicate {\itshape pred}. If {\itshape pred} returns true for that element then it will be counted.
...
\hline
\mbox{\tt in}  & {\em value} & The value to be counted\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
1.\+0.\+0 
\end{DoxySince}
\index{prism@{prism}!delete\+\_\+range@{delete\+\_\+range}}
...
Deletes the elements in a range. 

Each element in the range \mbox{[}first,last\mbox{]} will be deleted with the use of the c++ delete operator. Therefore each element must be a pointer.

The range is {\itshape }\mbox{[}first,last\mbox{]}, which contains all the elements between {\itshape first} and {\itshape last}, including the element pointed to by {\itshape first} but not the element pointed to by {\itshape last}.


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em first} & An iterator that points to the start of the range to be deleted \\
\hline
\mbox{\tt in}  & {\em last} & An iterator that points to one position past the last element to be deleted\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Nothing
...
1.\+0.\+0 
\end{DoxySince}
\index{prism@{prism}!destroy@{destroy}}
...
Returns the distance between two Random\+Access\+Iterators. \index{prism@{prism}!end@{end}}
...
Compares all the elements in the range \mbox{[}first,last\mbox{]} against the elements in the range beginning from @ other\+First. Comparison is made using \hyperlink{namespaceprism_a1faf99d35e2cbb2b8c0644aa0b777e9b}{operator==()} so the element must support that operator.
...
Transforms a range \mbox{[}first,last\mbox{]} in such a way that it forms a heap. This makes retrieving the element with the highest value very fast.
...
Determines which value is smaller. 

Compares the values {\itshape a} and {\itshape b} to find out which one has the smaller value
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
{\itshape a} or {\itshape b}, whichever is the smaller value
\end{DoxyReturn}
\begin{DoxySince}{Since}
1.\+0.\+0 
\end{DoxySince}
...
Returns true if the raw pointer p1 and the managed pointer of p2 point to the same data, false otherwise. \index{prism@{prism}!previous@{previous}}
...
\index{prism@{prism}!print\+Tree@{print\+Tree}}
...
\subsubsection[{\texorpdfstring{remove\+\_\+copy\+\_\+if(\+Input\+Iterator first, Input\+Iterator last, Output\+Iterator other\+First, Predicate pred)}{remove_copy_if(InputIterator first, InputIterator last, OutputIterator otherFirst, Predicate pred)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Input\+Iterator , class Output\+Iterator , class Predicate $>$ Output\+Iterator prism\+::remove\+\_\+copy\+\_\+if (
\begin{DoxyParamCaption}
\item[{Input\+Iterator}]{first, }
\item[{Input\+Iterator}]{last, }
\item[{Output\+Iterator}]{other\+First, }
\item[{Predicate}]{pred}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a1d5e88689f200fe9a6ea33642321f1fa}{}\label{namespaceprism_a1d5e88689f200fe9a6ea33642321f1fa}


Copies all elements from a range (except for those elements for which a predicate returns true) into another range. 
...
Assigns a new value to all elements for which a predicate is true. 
...
Searches for a sub-\/range within a range. 
...
Exchanges the values of each of the elements in the range {\itshape }\mbox{[}first1,last1\mbox{]} with those of their respective elements in the range beginning at {\itshape other\+First}. All of the elements in the range \mbox{[}first,last\mbox{]} are swapped with the elements in the range beginning from {\itshape other\+First}. The element type must support operator=().
