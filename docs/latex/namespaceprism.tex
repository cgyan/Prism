...
\item 
class \hyperlink{classprism_1_1_console}{Console}
\item 
...
\item 
{\footnotesize template$<$class T $>$ }\\void \hyperlink{namespaceprism_a296f6880e6bb0011e60dcc658e097ed6}{output} (const T \&value)
\item 
\hyperlink{classprism_1_1_console}{Console} \hyperlink{namespaceprism_a7c20bd0fa006919ffd45f3036b91eafc}{console} ()
\item 
...
Searches the range {\itshape }\mbox{[}first,last) for the first occurrence of two consecutive elements that match, and returns an iterator to the first of these two elements, or {\itshape last} if no such pair is found. \index{prism@{prism}!all\+\_\+of@{all\+\_\+of}}
...
Returns true if {\itshape pred} returns true for any of the elements in the range {\itshape }\mbox{[}first, last\mbox{]}. \index{prism@{prism}!console@{console}}
\index{console@{console}!prism@{prism}}
\subsubsection[{\texorpdfstring{console()}{console()}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Console} prism\+::console (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a7c20bd0fa006919ffd45f3036b91eafc}{}\label{namespaceprism_a7c20bd0fa006919ffd45f3036b91eafc}
...
Copies the elements in the range {\itshape }\mbox{[}first,last) into the range beginning at {\itshape other\+First}. \index{prism@{prism}!copy\+\_\+backward@{copy\+\_\+backward}}
...
Copies the elements in the range {\itshape }\mbox{[}first,last) for which {\itshape pred} returns true to the range beginning at {\itshape other\+First}. \index{prism@{prism}!copy\+\_\+n@{copy\+\_\+n}}
...
Returns the number of elements in the range {\itshape }\mbox{[}first,last) for which {\itshape pred} is true. \index{prism@{prism}!delete\+\_\+range@{delete\+\_\+range}}
...
Returns an iterator to the first element in the range {\itshape }\mbox{[}first,last) that compares equal to {\itshape value}. If no such element is found, the function returns {\itshape last}. \index{prism@{prism}!find\+\_\+if@{find\+\_\+if}}
...
Returns an iterator to the first element in the range {\itshape }\mbox{[}first,last) for which {\itshape pred} returns true. If no such element is found, the function returns {\itshape last}. \index{prism@{prism}!find\+\_\+last@{find\+\_\+last}}
...
Applies function {\itshape func} to each of the elements in the range {\itshape }\mbox{[}first,last). \index{prism@{prism}!max@{max}}
...
Returns true if {\itshape pred} returns false for all the elements in the range {\itshape }\mbox{[}first,last) or if the range is empty, and false otherwise. \index{prism@{prism}!operator"!=@{operator"!=}}
...
\index{operator+@{operator+}!prism@{prism}}
\subsubsection[{\texorpdfstring{operator+(const String \&str1, const String \&str2)}{operator+(const String &str1, const String &str2)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} prism\+::operator+ (
\begin{DoxyParamCaption}
\item[{const {\bf String} \&}]{str1, }
\item[{const {\bf String} \&}]{str2}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a4d401776635a858ca8f279b6ee6a35f4}{}\label{namespaceprism_a4d401776635a858ca8f279b6ee6a35f4}
\index{prism@{prism}!operator+@{operator+}}
\index{operator+@{operator+}!prism@{prism}}
\subsubsection[{\texorpdfstring{operator+(const String \&str1, const char $\ast$str2)}{operator+(const String &str1, const char *str2)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} prism\+::operator+ (
\begin{DoxyParamCaption}
\item[{const {\bf String} \&}]{str1, }
\item[{const char $\ast$}]{str2}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_aa0e135948cfe325d658fd6e65ef3b754}{}\label{namespaceprism_aa0e135948cfe325d658fd6e65ef3b754}
\index{prism@{prism}!operator+@{operator+}}
\index{operator+@{operator+}!prism@{prism}}
\subsubsection[{\texorpdfstring{operator+(const char $\ast$str1, const String \&str2)}{operator+(const char *str1, const String &str2)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} prism\+::operator+ (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{str1, }
\item[{const {\bf String} \&}]{str2}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a6eceab4fd9349dda5fc47e0806ce168f}{}\label{namespaceprism_a6eceab4fd9349dda5fc47e0806ce168f}
\index{prism@{prism}!operator+@{operator+}}
\index{operator+@{operator+}!prism@{prism}}
\subsubsection[{\texorpdfstring{operator+(const char c, const String \&str)}{operator+(const char c, const String &str)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} prism\+::operator+ (
\begin{DoxyParamCaption}
\item[{const char}]{c, }
\item[{const {\bf String} \&}]{str}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_ae7a27033c4b2b541f9f582119bcd188a}{}\label{namespaceprism_ae7a27033c4b2b541f9f582119bcd188a}
\index{prism@{prism}!operator+@{operator+}}
\index{operator+@{operator+}!prism@{prism}}
\subsubsection[{\texorpdfstring{operator+(const String \&str, const char c)}{operator+(const String &str, const char c)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf String} prism\+::operator+ (
\begin{DoxyParamCaption}
\item[{const {\bf String} \&}]{str, }
\item[{const char}]{c}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a07058e194f9108ce695ab99b6aaa7db1}{}\label{namespaceprism_a07058e194f9108ce695ab99b6aaa7db1}
\index{prism@{prism}!operator-\/@{operator-\/}}
\index{operator-\/@{operator-\/}!prism@{prism}}
\subsubsection[{\texorpdfstring{operator-\/(const Fraction \&f1, const Fraction \&f2)}{operator-(const Fraction &f1, const Fraction &f2)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Fraction} prism\+::operator-\/ (
\begin{DoxyParamCaption}
...
\end{DoxyReturn}
\index{prism@{prism}!output@{output}}
\index{output@{output}!prism@{prism}}
\subsubsection[{\texorpdfstring{output(const T \&value)}{output(const T &value)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ void prism\+::output (
\begin{DoxyParamCaption}
\item[{const T \&}]{value}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a296f6880e6bb0011e60dcc658e097ed6}{}\label{namespaceprism_a296f6880e6bb0011e60dcc658e097ed6}
...
Transforms the range {\itshape }\mbox{[}first,last) into a range with all the elements that compare equal to {\itshape value} removed, and returns an iterator to the new end of that range. \index{prism@{prism}!remove\+\_\+copy@{remove\+\_\+copy}}
...
Copies the elements in the range {\itshape }\mbox{[}first,last) to the range beginning at {\itshape other\+First}, except those elements that compare equal to {\itshape value}. \index{prism@{prism}!remove\+\_\+copy\+\_\+if@{remove\+\_\+copy\+\_\+if}}
...
Copies the elements in the range {\itshape }\mbox{[}first,last) to the range beginning at {\itshape other\+First}, except those elements for which {\itshape pred} returns true. \index{prism@{prism}!remove\+\_\+if@{remove\+\_\+if}}
...
Transforms the range {\itshape }\mbox{[}first,last) into a range with all the elements for which {\itshape pred} returns true removed, and returns an iterator to the new end of that range. \index{prism@{prism}!replace@{replace}}
...
Assigns {\itshape new\+Value} to all the elements in the range {\itshape }\mbox{[}first,last) that compare equal to {\itshape old\+Value}. \index{prism@{prism}!replace\+\_\+copy@{replace\+\_\+copy}}
...
Copies the elements in the range {\itshape }\mbox{[}first,last) to the range beginning at {\itshape other\+First}, replacing the appearances of {\itshape old\+Value} by {\itshape new\+Value}. \index{prism@{prism}!replace\+\_\+copy\+\_\+if@{replace\+\_\+copy\+\_\+if}}
...
Copies the elements in the range {\itshape }\mbox{[}first,last) to the range beginning at {\itshape other\+First}, replacing those for which {\itshape pred} returns true by new\+Value. \index{prism@{prism}!replace\+\_\+if@{replace\+\_\+if}}
...
Assigns {\itshape new\+Value} to all the elements in the range {\itshape }\mbox{[}first,last) for which {\itshape pred} returns true. \index{prism@{prism}!search@{search}}
...
Searches the range \mbox{[}first1,last1) for the first occurrence of the sequence defined by \mbox{[}first2,last2), and returns an iterator to its first element, or last1 if no occurrences are found. The range used is \mbox{[}first1,last1), which contains all the elements between first1 and last1, including the element pointed by first1 but not the element pointed by last1. \index{prism@{prism}!sort@{sort}}
\index{sort@{sort}!prism@{prism}}
\subsubsection[{\texorpdfstring{sort(\+Random\+Access\+Iterator first, Random\+Access\+Iterator last)}{sort(RandomAccessIterator first, RandomAccessIterator last)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Random\+Access\+Iterator $>$ void prism\+::sort (
\begin{DoxyParamCaption}
\item[{Random\+Access\+Iterator}]{first, }
\item[{Random\+Access\+Iterator}]{last}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_af8ceeac6329dade75da361abe8b15c5f}{}\label{namespaceprism_af8ceeac6329dade75da361abe8b15c5f}
Sorts the elements in the range {\itshape }\mbox{[}first, last\mbox{]} in ascending order using bubble sort. \index{prism@{prism}!swap@{swap}}
...
Exchanges the values of each of the elements in the range {\itshape }\mbox{[}first1,last1) with those of their respective elements in the range beginning at {\itshape other\+First}. 