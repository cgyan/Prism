...
Moves the iterator forwards by num\+Steps (or backwards if num\+Steps is negative). \index{prism@{prism}!advance\+\_\+aux@{advance\+\_\+aux}}
\index{advance\+\_\+aux@{advance\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{advance\+\_\+aux(\+Input\+Iterator \&iterator, int num\+Steps, prism\+::forward\+\_\+iterator\+\_\+tag)}{advance_aux(InputIterator &iterator, int numSteps, prism::forward_iterator_tag)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Input\+Iterator $>$ void prism\+::advance\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Input\+Iterator \&}]{iterator, }
\item[{int}]{num\+Steps, }
\item[{{\bf prism\+::forward\+\_\+iterator\+\_\+tag}}]{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_add6ff58cf31e54607539740e32e030e6}{}\label{namespaceprism_add6ff58cf31e54607539740e32e030e6}
Advance function for input iterators. Can only advance forwards and not backwards. \index{prism@{prism}!advance\+\_\+aux@{advance\+\_\+aux}}
\index{advance\+\_\+aux@{advance\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{advance\+\_\+aux(\+Bidirectional\+Iterator \&iterator, int num\+Steps, prism\+::bidirectional\+\_\+iterator\+\_\+tag)}{advance_aux(BidirectionalIterator &iterator, int numSteps, prism::bidirectional_iterator_tag)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Bidirectional\+Iterator $>$ void prism\+::advance\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Bidirectional\+Iterator \&}]{iterator, }
\item[{int}]{num\+Steps, }
\item[{{\bf prism\+::bidirectional\+\_\+iterator\+\_\+tag}}]{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a1bba402ba796a42eb306d91c41f99bf7}{}\label{namespaceprism_a1bba402ba796a42eb306d91c41f99bf7}
Advance function for bidirectional iterators. Can advance forwards and also backwards (if num\+Steps is negative). \index{prism@{prism}!advance\+\_\+aux@{advance\+\_\+aux}}
\index{advance\+\_\+aux@{advance\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{advance\+\_\+aux(\+Random\+Access\+Iterator \&iterator, int num\+Steps, prism\+::random\+\_\+access\+\_\+iterator\+\_\+tag)}{advance_aux(RandomAccessIterator &iterator, int numSteps, prism::random_access_iterator_tag)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Random\+Access\+Iterator $>$ void prism\+::advance\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Random\+Access\+Iterator \&}]{iterator, }
\item[{int}]{num\+Steps, }
\item[{{\bf prism\+::random\+\_\+access\+\_\+iterator\+\_\+tag}}]{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a3fe20025afc246261967bbfce7953d37}{}\label{namespaceprism_a3fe20025afc246261967bbfce7953d37}
Advance function for random access iterators. \index{prism@{prism}!all\+\_\+of@{all\+\_\+of}}
...
}\hypertarget{namespaceprism_a6d7a987672303bcc2aad6eedfa3c97c5}{}\label{namespaceprism_a6d7a987672303bcc2aad6eedfa3c97c5}
...
}\hypertarget{namespaceprism_a1d797e0ebd535413f23ff6c378bce541}{}\label{namespaceprism_a1d797e0ebd535413f23ff6c378bce541}
...
\hyperlink{classprism_1_1_array}{Array} specialization. \index{prism@{prism}!begin@{begin}}
\index{begin@{begin}!prism@{prism}}
...
Deque\+Memory handles the allocations and deallocations of the storage and buckets but doesn\textquotesingle{}t construct or destruct anything. i.\+e. constructers and destructors \subsection*{are not called from this class. }
...
Returns the distance between two iterators. \index{prism@{prism}!distance\+\_\+aux@{distance\+\_\+aux}}
\index{distance\+\_\+aux@{distance\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{distance\+\_\+aux(\+Forward\+Iterator first, Forward\+Iterator last, forward\+\_\+iterator\+\_\+tag)}{distance_aux(ForwardIterator first, ForwardIterator last, forward_iterator_tag)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Forward\+Iterator $>$ {\bf prism\+::iterator\+\_\+traits}$<$Forward\+Iterator$>$\+::difference\+\_\+type prism\+::distance\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Forward\+Iterator}]{first, }
\item[{Forward\+Iterator}]{last, }
\item[{{\bf forward\+\_\+iterator\+\_\+tag}}]{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a533a2713a3809d8448bbfc2ebbddaa74}{}\label{namespaceprism_a533a2713a3809d8448bbfc2ebbddaa74}
Returns the distance between two Forward\+Iterators. \index{prism@{prism}!distance\+\_\+aux@{distance\+\_\+aux}}
\index{distance\+\_\+aux@{distance\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{distance\+\_\+aux(\+Random\+Access\+Iterator first, Random\+Access\+Iterator last, random\+\_\+access\+\_\+iterator\+\_\+tag)}{distance_aux(RandomAccessIterator first, RandomAccessIterator last, random_access_iterator_tag)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Random\+Access\+Iterator $>$ {\bf prism\+::iterator\+\_\+traits}$<$Random\+Access\+Iterator$>$\+::difference\+\_\+type prism\+::distance\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Random\+Access\+Iterator}]{first, }
\item[{Random\+Access\+Iterator}]{last, }
\item[{{\bf random\+\_\+access\+\_\+iterator\+\_\+tag}}]{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a3b40eca07d5c5dca59a232562628a001}{}\label{namespaceprism_a3b40eca07d5c5dca59a232562628a001}
Returns the distance between two Random\+Access\+Iterators. \index{prism@{prism}!empty@{empty}}
...
}\hypertarget{namespaceprism_acd1f6ce5ed6fe400694b77f49270ea36}{}\label{namespaceprism_acd1f6ce5ed6fe400694b77f49270ea36}
...
}\hypertarget{namespaceprism_a81b99f9ade4f7bd30ab1c5a64a20d539}{}\label{namespaceprism_a81b99f9ade4f7bd30ab1c5a64a20d539}
...
\hyperlink{classprism_1_1_array}{Array} specialization. \index{prism@{prism}!end@{end}}
\index{end@{end}!prism@{prism}}
...
\begin{DoxyNote}{Note}
The elements being compared must support \hyperlink{namespaceprism_a1faf99d35e2cbb2b8c0644aa0b777e9b}{operator==()}. 
\end{DoxyNote}
...
Returns the smallest of {\itshape a} and {\itshape b}. If they are equivalent then {\itshape a} is returned. \index{prism@{prism}!next@{next}}
...
\index{prism@{prism}!operator"!=@{operator"!=}}
\index{operator"!=@{operator"!=}!prism@{prism}}
\subsubsection[{\texorpdfstring{operator"!=(const Deque$<$ T, T\+\_\+\+Alloc $>$ \&rhs) const }{operator!=(const Deque< T, T_Alloc > &rhs) const }}]{\setlength{\rightskip}{0pt plus 5cm}const bool prism\+::operator!= (
\begin{DoxyParamCaption}
\item[{const {\bf Deque}$<$ T, T\+\_\+\+Alloc $>$ \&}]{rhs}
\end{DoxyParamCaption}
) const}\hypertarget{namespaceprism_a5842267ec092ff201f89eefcc9540b44}{}\label{namespaceprism_a5842267ec092ff201f89eefcc9540b44}
\index{prism@{prism}!operator\&@{operator\&}}
\index{operator\&@{operator\&}!prism@{prism}}
...
\item[{const {\bf Deque}$<$ T, T\+\_\+\+Alloc $>$ \&}]{rhs}
\end{DoxyParamCaption}
) const}\hypertarget{namespaceprism_a54ae8f7d8d796d783af55f13ae4de95b}{}\label{namespaceprism_a54ae8f7d8d796d783af55f13ae4de95b}
\index{prism@{prism}!operator$>$@{operator$>$}}
\index{operator$>$@{operator$>$}!prism@{prism}}
\subsubsection[{\texorpdfstring{operator$>$(const Char \&c1, const Char \&c2)}{operator>(const Char &c1, const Char &c2)}}]{\setlength{\rightskip}{0pt plus 5cm}const bool prism\+::operator$>$ (
\begin{DoxyParamCaption}
...
Moves the iterator {\itshape it} back by {\itshape num\+Steps}. Returns an iterator. \index{prism@{prism}!previous\+\_\+aux@{previous\+\_\+aux}}
\index{previous\+\_\+aux@{previous\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{previous\+\_\+aux(\+Bidirectional\+Iterator it, int num\+Steps=1)}{previous_aux(BidirectionalIterator it, int numSteps=1)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Bidirectional\+Iterator $>$ Bidirectional\+Iterator prism\+::previous\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Bidirectional\+Iterator}]{it, }
\item[{int}]{num\+Steps = {\ttfamily 1}}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_adc2f50ca26ef33527adf172e1f999bbc}{}\label{namespaceprism_adc2f50ca26ef33527adf172e1f999bbc}
...
Currently {\itshape \hyperlink{namespaceprism_addfe9ea0146b59b2b16adee4cd2220b9}{sort()}} is implemented using the quicksort algorithm which averages a reasonable O(n log(n)) complexity. \index{prism@{prism}!sort\+\_\+aux@{sort\+\_\+aux}}
\index{sort\+\_\+aux@{sort\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{sort\+\_\+aux(\+Bidirectional\+Iterator first, Bidirectional\+Iterator last)}{sort_aux(BidirectionalIterator first, BidirectionalIterator last)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Bidirectional\+Iterator $>$ void prism\+::sort\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Bidirectional\+Iterator}]{first, }
\item[{Bidirectional\+Iterator}]{last}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a79f1533ec8a11842db47a4d70cdbd056}{}\label{namespaceprism_a79f1533ec8a11842db47a4d70cdbd056}
Sorts the elements in the range {\itshape }\mbox{[}first,last\mbox{]} in ascending order using the quicksort algorithm. The range used is \mbox{[}first1,last1\mbox{]}, which contains all the elements between first1 and last1, including the element pointed by first1 but not the element pointed by last1. ~\newline
Currently {\itshape \hyperlink{namespaceprism_addfe9ea0146b59b2b16adee4cd2220b9}{sort()}} is implemented using the quicksort algorithm which averages a reasonable O(n log(n)) complexity. \index{prism@{prism}!sort\+\_\+bubble@{sort\+\_\+bubble}}
...
\subsubsection[{\texorpdfstring{sort\+\_\+bubble\+\_\+aux(\+Random\+Access\+Iterator first, Random\+Access\+Iterator last, prism\+::random\+\_\+access\+\_\+iterator\+\_\+tag)}{sort_bubble_aux(RandomAccessIterator first, RandomAccessIterator last, prism::random_access_iterator_tag)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Random\+Access\+Iterator $>$ void prism\+::sort\+\_\+bubble\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Random\+Access\+Iterator}]{first, }
\item[{Random\+Access\+Iterator}]{last, }
\item[{{\bf prism\+::random\+\_\+access\+\_\+iterator\+\_\+tag}}]{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a1e22fc5d6e1e94cf7d9d76cee8dcb281}{}\label{namespaceprism_a1e22fc5d6e1e94cf7d9d76cee8dcb281}
Bubble sort for random access iterators \index{prism@{prism}!sort\+\_\+bubble\+\_\+aux@{sort\+\_\+bubble\+\_\+aux}}
\index{sort\+\_\+bubble\+\_\+aux@{sort\+\_\+bubble\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{sort\+\_\+bubble\+\_\+aux(\+Bidirectional\+Iterator first, Bidirectional\+Iterator last, prism\+::bidirectional\+\_\+iterator\+\_\+tag)}{sort_bubble_aux(BidirectionalIterator first, BidirectionalIterator last, prism::bidirectional_iterator_tag)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Bidirectional\+Iterator $>$ void prism\+::sort\+\_\+bubble\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Bidirectional\+Iterator}]{first, }
\item[{Bidirectional\+Iterator}]{last, }
\item[{{\bf prism\+::bidirectional\+\_\+iterator\+\_\+tag}}]{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a8132b98c9ee1d630059074e1779341b2}{}\label{namespaceprism_a8132b98c9ee1d630059074e1779341b2}
Bubble sort for bidirectional iterators \index{prism@{prism}!sort\+\_\+heap@{sort\+\_\+heap}}
...
\subsubsection[{\texorpdfstring{sort\+\_\+quicksort\+\_\+aux(\+Random\+Access\+Iterator first, Random\+Access\+Iterator last, prism\+::random\+\_\+access\+\_\+iterator\+\_\+tag it\+\_\+cat)}{sort_quicksort_aux(RandomAccessIterator first, RandomAccessIterator last, prism::random_access_iterator_tag it_cat)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Random\+Access\+Iterator $>$ void prism\+::sort\+\_\+quicksort\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Random\+Access\+Iterator}]{first, }
\item[{Random\+Access\+Iterator}]{last, }
\item[{{\bf prism\+::random\+\_\+access\+\_\+iterator\+\_\+tag}}]{it\+\_\+cat}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_ae5aebde51f8677c6608cf202e02eac6c}{}\label{namespaceprism_ae5aebde51f8677c6608cf202e02eac6c}
Quicksort for random access iterators \index{prism@{prism}!sort\+\_\+quicksort\+\_\+aux@{sort\+\_\+quicksort\+\_\+aux}}
\index{sort\+\_\+quicksort\+\_\+aux@{sort\+\_\+quicksort\+\_\+aux}!prism@{prism}}
\subsubsection[{\texorpdfstring{sort\+\_\+quicksort\+\_\+aux(\+Bidirectional\+Iterator first, Bidirectional\+Iterator last, prism\+::bidirectional\+\_\+iterator\+\_\+tag)}{sort_quicksort_aux(BidirectionalIterator first, BidirectionalIterator last, prism::bidirectional_iterator_tag)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Bidirectional\+Iterator $>$ void prism\+::sort\+\_\+quicksort\+\_\+aux (
\begin{DoxyParamCaption}
\item[{Bidirectional\+Iterator}]{first, }
\item[{Bidirectional\+Iterator}]{last, }
\item[{{\bf prism\+::bidirectional\+\_\+iterator\+\_\+tag}}]{}
\end{DoxyParamCaption}
)}\hypertarget{namespaceprism_a49b96350afdd8de11aac6b0c74f78c99}{}\label{namespaceprism_a49b96350afdd8de11aac6b0c74f78c99}
Quicksort for bidirectional iterators todo Not a great solution for quicksorting a bidirectional iterator based container! Currently copies the elements into an array, then sorts using the random access quicksort then copies the sorted elements back into the original container.... \+:-\/( \index{prism@{prism}!starts\+With@{starts\+With}}
