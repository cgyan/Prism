...
Searches the range \mbox{[}first1,last1) for the first occurrence of the sequence defined by \mbox{[}first2,last2), and returns an iterator to its first element, or last1 if no occurrences are found. The range used is \mbox{[}first1,last1), which contains all the elements between first1 and last1, including the element pointed by first1 but not the element pointed by last1. \index{prism@{prism}!sort\+\_\+bubble@{sort\+\_\+bubble}}
