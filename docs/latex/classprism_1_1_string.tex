...
\begin{DoxyReturn}{Returns}
Returns a new string which is composed of this string repeated {\itshape n\+Times}. Replaces {\itshape n\+Chars} of characters starting at {\itshape position} (0-\/based) with {\itshape str}. 
\begin{DoxyCode}
